...
func SetGitProcessEnv(t *testing.T) {
	...
	t.Setenv("GIT_AUTHOR_NAME", "git-wr-test")
	t.Setenv("GIT_AUTHOR_EMAIL", "git-wr-test@example.invalid")
	t.Setenv("GIT_COMMITTER_NAME", "git-wr-test")
	t.Setenv("GIT_COMMITTER_EMAIL", "git-wr-test@example.invalid")
