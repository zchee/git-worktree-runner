...
func SetGitProcessEnv(t *testing.T) {
	...
	t.Setenv("GIT_AUTHOR_NAME", "git-gwr-test")
	t.Setenv("GIT_AUTHOR_EMAIL", "git-gwr-test@example.invalid")
	t.Setenv("GIT_COMMITTER_NAME", "git-gwr-test")
	t.Setenv("GIT_COMMITTER_EMAIL", "git-gwr-test@example.invalid")
