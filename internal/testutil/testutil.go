...
func Git(t *testing.T) gitcmd.Git {
	...
	g.Env = []string{
		"GIT_AUTHOR_NAME=git-gwr-test",
		"GIT_AUTHOR_EMAIL=git-gwr-test@example.invalid",
		"GIT_COMMITTER_NAME=git-gwr-test",
		"GIT_COMMITTER_EMAIL=git-gwr-test@example.invalid",
