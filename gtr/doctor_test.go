...
func TestDoctorReport(t *testing.T) {
	...
	if _, err := g.Run(t.Context(), repoDir, "config", "--local", "gwr.editor.default", "myeditor"); err != nil {
		t.Fatalf("git config gwr.editor.default: %v", err)
	}
	if _, err := g.Run(t.Context(), repoDir, "config", "--local", "gwr.ai.default", "myai"); err != nil {
