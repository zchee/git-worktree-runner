...
git-worktree-runner (a.k.a. `git-gwr`) is a Go port of [github.com/coderabbitai/git-worktree-runner](https://github.com/coderabbitai/git-worktree-runner) with some additional features.
