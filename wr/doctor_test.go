...
func TestDoctorReport(t *testing.T) {
	...
	if _, err := g.Run(t.Context(), repoDir, "config", "--local", "wr.editor.default", "myeditor"); err != nil {
		t.Fatalf("git config wr.editor.default: %v", err)
	}
	if _, err := g.Run(t.Context(), repoDir, "config", "--local", "wr.ai.default", "myai"); err != nil {
